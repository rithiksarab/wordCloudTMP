...
class CommentGenerator
  NEW_CLOUD_URL = "https://raw.githubusercontent.com/rithiksarab/wordCloudTMP/master/previous_clouds/#{CloudTypes::CLOUDLABELS[-2]}_cloud#{CloudTypes::CLOUDLABELS.size - 1}.png"
  ADDWORD = 'add'
  ...
  def generate
    ...
    **:star2: Enjoyed yourself? [Add a word](https://github.com/rithiksarab) to the NEW word cloud :fire:**
