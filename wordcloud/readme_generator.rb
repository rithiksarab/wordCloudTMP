...
class ReadmeGenerator
  WORD_CLOUD_URL = 'https://raw.githubusercontent.com/rithiksarab/wordCloudTMP/master/wordcloud/wordcloud.png'
  ADDWORD = 'add'
...
[<b>▷▻⊳ 𝐁𝐚𝐜𝐤 𝐓𝐨 𝐏𝐫𝐨𝐟𝐢𝐥𝐞 ⊲◅◁</b>](https://github.com/rithiksarab/rithiksarab)    
#
<!--✏️WORDBOARD / 🌐WEBSITE: https://github.com/JessicaLim8/JessicaLim8 --> 
<h2 align="center">
Join the Word Cloud Board :cloud: :pencil2:

### :thought_balloon: [Add your name](https://github.com/rithiksarab/wordCloudTMP/issues/new?template=addword.md&title=wordcloud%7Cadd%7C%3CINSERT-WORD%3E) to see the word cloud update in real time :rocket:

:star2: Don't like the arrangement? [Regenerate it](https://github.com/rithiksarab/wordCloudTMP/issues/new?template=shufflecloud.md&title=wordcloud%7Cshuffle) :game_die:
...
<img src="#{WORD_CLOUD_URL}" alt="WordCloud" width="100%">
  ...
  def previous_cloud_url
    ...
    "https://github.com/rithiksarab/wordCloudTMP/blob/master/previous_clouds/previous_clouds.md##{url_end}"
  end
